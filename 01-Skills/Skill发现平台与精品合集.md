...
这一页专门解决一个现实问题：就算已经知道 Skills 很重要，也很容易被碎片化仓库淹没。这里把“发现平台、安装工具、精品合集、历史桥接工具”单独拆出来，方便后续持续扫新。
...
| 资源 | 类型 | 简述 | 链接 |
| --- | --- | --- | --- |
| VoltAgent Awesome Agent Skills | 大型总表 | 覆盖官方团队和社区高信号技能，兼容 Claude Code、Codex、Copilot、Cursor 等多个宿主。 | [VoltAgent/awesome-agent-skills](https://github.com/VoltAgent/awesome-agent-skills) |
| GitHub Awesome Copilot | 官方社区集合 | 不只收 skills，也收 agents、instructions、prompts、collections，但对 Copilot/跨平台技能生态很有参考价值。 | [github/awesome-copilot](https://github.com/github/awesome-copilot) |
...
| Skill Builder | 构建型 skill | 用 Skill 帮继续写 Skill，适合把内部能力沉成模板。 | [metaskills/skill-builder](https://github.com/metaskills/skill-builder) |
