...
| OpenAI Skills Catalog | Codex 官方目录 | `openai/skills` 是 Codex 的公开技能目录，能帮助从 Codex 视角理解 curated / experimental / system skills。 | [openai/skills](https://github.com/openai/skills) |
