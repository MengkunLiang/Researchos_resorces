...
| OpenML | 开放 benchmark 平台 | 提供标准化数据集、任务、runs 和 suites，适合给你们内部实验建立可复现对照基线。 | [OpenML](https://openml.io/) |
...
| 资源 | 类型 | 简述 | 链接 |
| --- | --- | --- | --- |
| llm4novelty / NovBench | novelty benchmark | 专门针对学术新颖性判断，是你们做 idea / novelty 系统时最该补齐的一项。 | [njust-winchy/llm4novelty](https://github.com/njust-winchy/llm4novelty) |
...
3. 如果你们做 idea / novelty，就再补 `llm4novelty / NLPeer / OpenReview`
